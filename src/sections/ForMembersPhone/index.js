      ...
      <div className={styles.content_wrapper}>
        ...
        <div className={styles.bottom_text}>
          <div className={styles.bottom_text_heading}>
            ...
            <div className={styles.bottom_text_heading_text}>FOR MEMBERS.</div>
          </div>
          <div className={styles.bottom_text_description}>
            LineUp makes you an insider—discover events that match your vibe,
            see who{"'"}s going, connect with other members, and SECURE ENTRIES
            TO EVENTS YOU LOVE. so every event feels like hanging out with
            friends.
          </div>
        </div>
      </div>
