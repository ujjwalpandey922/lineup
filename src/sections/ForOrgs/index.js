        ...
        <div className={styles.container}>
            ...
            <div className={styles.right}>
                <div className={styles.container_text}>
                   ...
                   <div className={styles.container_text_description}>LineUp puts event hosting on autopilot—no upfront costs or middlemen. Book venues and talent with built-in insurance, chat, and payments so you can focus on the vibe, not the paperwork. Sell tickets in minutes and grow your community effortlessly.</div>
                </div>
